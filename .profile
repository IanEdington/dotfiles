#  Description: This file holds all my BASH configs and aliases
#
#  Sections:
#  0.   Personalization
#  1.   Environment Configuration
#  2.   Remap and add functionality to Terminal Commands
...
#  	Bookmarks: these are files I nav to often.
			alias udacity-coursework='cd ~/Dropbox/dev/udacity_coursework/'
			alias udacity-project='cd ~/Dropbox/dev/udacity_project/'
			alias playground='cd ~/Dropbox/dev/playground/'

#  	Python Dev Environment
		# Python project virtual environment
				alias .env='source .env/bin/activate'
		# Anaconda environments (3.4 & 2.7)
